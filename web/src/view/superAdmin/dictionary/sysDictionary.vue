    ...
    <div class="search-term">
      <el-form :inline="true"
        ...
        <el-form-item label="字典名（英）">
          <el-input placeholder="搜索条件"
                    v-model="searchInfo.type"></el-input>
        </el-form-item>
        ...
        <el-form-item label="描述">
          <el-input placeholder="搜索条件"
                    v-model="searchInfo.desc"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <el-table :data="tableData"
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button @click="toDetile(scope.row)"
                     size="small"
                     type="success">详情</el-button>
          <el-button @click="updateSysDictionary(scope.row)"
                     size="small"
