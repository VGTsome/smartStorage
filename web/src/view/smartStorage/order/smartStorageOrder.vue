  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">        
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增smartStorageOrder表</el-button>
        </el-form-item>
        <el-form-item>
    ...
    <el-table-column label="orderStatus字段" prop="orderStatus" width="120"></el-table-column> 
      ...
      <el-table-column label="按钮组">
        <template slot-scope="scope">
          <el-button @click="updateSmartStorageOrder(scope.row)" size="small" type="primary">变更</el-button>
          <el-popover placement="top" width="160" v-model="scope.row.visible">
            <p>确定要删除吗？</p>
            <div style="text-align: right; margin: 0">
              <el-button size="mini" type="text" @click="scope.row.visible = false">取消</el-button>
              <el-button type="primary" size="mini" @click="deleteSmartStorageOrder(scope.row)">确定</el-button>
            </div>
...
export default {
  ...
  data() {
    return {
      listApi: getSmartStorageOrderList,
