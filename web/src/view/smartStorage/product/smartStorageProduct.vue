  ...
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">            
        ...
        <el-form-item>
          <el-button @click="openDialog" type="primary">新增smartStorageProduct表</el-button>
        </el-form-item>
        <el-form-item>
        ...
        <template slot-scope="scope">
          ...
          <el-popover placement="top" width="160" v-model="scope.row.visible">
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button type="primary" size="mini" @click="deleteSmartStorageProduct(scope.row)">确定</el-button>
            </div>
