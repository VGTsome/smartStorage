...
type System struct {
	...
	StorageIPaddr       string `mapstructure:"com-ipaddr" json:"com-ipaddr" yaml:"com-ipaddr"`
	DoorIPaddr      string `mapstructure:"door-ipaddr" json:"door-ipaddr" yaml:"door-ipaddr"`
}
